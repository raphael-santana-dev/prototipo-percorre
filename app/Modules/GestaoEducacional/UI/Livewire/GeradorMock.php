...
class GeradorMock extends Component
{
    ...
    public function gerarAmbienteCompleto()
    {
        ...
        try {
            // 1. DADOS ACADÊMICOS BASE (Unidade, Curso, Turno)
            ...
            $professor = User::firstOrCreate(
                ...
                ['name' => 'Prof. Avaliador Mock', 'password' => Hash::make('senha123')]
            );
            ...
            // Vincula o Professor à Turma
            DB::table('professor_turma')->insert(['turma_id' => $turmaId, 'user_id' => $professor->id, 'created_at' => now()]);

            // Cria a Matrícula e Vincula à Turma
            ...
            DB::table('matricula_turma')->insert(['matricula_id' => $matriculaId, 'turma_id' => $turmaId, 'created_at' => now()]);
            ...
            // 6. PERÍODO E FASES
            $periodo = PeriodoAvaliacao::create([
                'ano' => '2026',
                'ciclo' => '1',
                'data_inicio' => now(),
            ...
            $periodo->criterios()->sync([$crit1->id, $crit2->id, $crit3->id]);

            PeriodoFase::create(['periodo_id' => $periodo->id, 'fase' => '1', 'responsavel' => '1']);
            PeriodoFase::create(['periodo_id' => $periodo->id, 'fase' => '2', 'responsavel' => '2']);
            PeriodoFase::create(['periodo_id' => $periodo->id, 'fase' => '3', 'responsavel' => '3']);
            ...
            $this->dispatch('sucesso', msg: 'Ambiente completo de avaliação gerado com sucesso!');
