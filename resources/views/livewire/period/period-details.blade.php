                ...
                <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-4">
                    ...
                    <div class="flex items-center gap-3 w-full sm:w-auto">
                        ...
                        <button wire:click="recalcularPontuacoes" 
                                ...
                                class="flex items-center justify-center h-[34px] w-[34px] sm:w-auto sm:px-3 gap-2 bg-yellow-50 hover:bg-yellow-100 border border-yellow-200 text-yellow-700 font-bold rounded-lg transition shadow-sm disabled:opacity-50">
                            ...
                            <span class="hidden sm:inline text-xs">Recalcular Scores</span>
                        </button>
                    </div>
                </div>
                    ...
                    <table class="min-w-full w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        <thead class="text-xs text-gray-400 uppercase border-b border-gray-100 dark:border-gray-700">
                            <tr>
                                ...
                                <th class="px-2 py-3 font-medium text-center whitespace-nowrap">Score</th>
                        ...
                        <tbody class="divide-y divide-gray-50 dark:divide-gray-700/50">
                            @forelse($inscricoes as $inscricao)
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
                                    ...
                                    <td class="px-2 py-3 text-center whitespace-nowrap">
                                        <span class="px-2 py-1 text-xs font-bold {{ $inscricao->pontuacao_total > 0 ? 'text-green-700 bg-green-50 border border-green-200' : 'text-gray-400 bg-gray-50' }} rounded-full">
