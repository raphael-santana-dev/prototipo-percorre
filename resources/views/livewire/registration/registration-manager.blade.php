    ...
    @if($modalAberto)
        <x-modal title="Cadastrar Nova Inscrição" max-width="md" close-method="fecharModal">
            <form wire:submit.prevent="salvarNovaInscricao" class="space-y-4">
                ...
                <div class="bg-indigo-50 dark:bg-indigo-900/30 border border-indigo-200 dark:border-indigo-800 p-3 rounded-lg text-xs text-indigo-700 dark:text-indigo-300 font-medium mb-3">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        @error('cpf') <span class="text-red-500 text-[10px] font-bold uppercase mt-1 block">{{ $message }}</span> @enderror
                    </div>
                    <div>
                        ...
                        @error('celular') <span class="text-red-500 text-[10px] font-bold uppercase mt-1 block">{{ $message }}</span> @enderror
                    </div>
                </div>

                <div>
                    <label class="block text-[11px] font-bold text-gray-500 uppercase tracking-wider mb-1">E-mail de Contato <span class="text-red-500">*</span></label>
                ...
                <div class="flex justify-end gap-3 pt-5 mt-4 border-t border-gray-100 dark:border-gray-700">
