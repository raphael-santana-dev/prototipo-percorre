<div class="p-6 max-w-7xl mx-auto font-sans relative">
    ...
    <div class="mb-8">
        ...
        <p class="text-gray-500 dark:text-gray-400 mt-2">Escolha abaixo o tipo de formulário que você deseja criar. O sistema adaptará as regras automaticamente.</p>
    </div>
...
s            <div class="relative z-10">
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400 mb-6 flex-1">
                    Crie o formulário de inscrição. Os dados coletados terão um cálculo de pontuação e ranqueamento.
                </p>
