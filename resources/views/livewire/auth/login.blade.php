<div class="flex min-h-screen bg-white dark:bg-gray-900 w-full">
    ...
    <div class="hidden lg:flex lg:w-1/2 relative bg-[#2b0940] items-center justify-center overflow-hidden">
        ...
        <div class="relative z-10 text-white text-center px-12 lg:px-24">
            ...
            <h1 class="text-4xl lg:text-5xl font-extrabold tracking-tight mb-6 leading-tight">Gestão da <br><span class="text-transparent bg-clip-text bg-gradient-to-r from-purpura-400 to-ponkan-400">Educação</span></h1>
            <p class="text-lg text-white/80 font-medium">Acesso restrito para administradores e equipe do Instituto Percorre.</p>
        </div>
    </div>
    ...
    <div class="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12 lg:p-24 bg-gray-50 dark:bg-gray-950">
        ...
        <div class="w-full max-w-md space-y-8 animate-fade-in-down">
            ...
            <div class="text-center pb-2">
                <!-- Mostra a logo preta/branca no mobile já que a imagem da esquerda some -->
                ...
                <h2 class="text-3xl font-extrabold text-gray-900 dark:text-white">Acesso Restrito</h2>
                <p class="mt-2 text-sm font-medium text-gray-500 dark:text-gray-400">Insira suas credenciais para entrar no painel</p>
            </div>
            
            <form wire:submit="authenticate" class="space-y-6 mt-8">
                
                <div>
                    <label for="email" class="block text-sm font-bold text-gray-700 dark:text-gray-300">E-mail Corporativo</label>
                    <div class="relative mt-2">
                        <i class="absolute text-gray-400 transform -translate-y-1/2 left-4 top-1/2 ph ph-envelope-simple text-lg"></i>
                        <input id="email" type="email" wire:model="email" class="w-full pl-12 py-3 bg-white border border-gray-200 rounded-xl shadow-sm focus:border-purpura-500 focus:ring-2 focus:ring-purpura-500/20 dark:bg-gray-900 dark:border-gray-700 dark:text-white transition-all" placeholder="admin@percorre.com.br" required autofocus>
                    </div>
                ...
                <div class="pt-4">
                    <button type="submit" class="flex items-center justify-center w-full px-4 py-3.5 text-sm font-bold text-white transition-transform transform rounded-xl shadow-sm bg-[#2b0940] hover:bg-purpura-800 hover:-translate-y-0.5">
                        Entrar no Sistema <i class="ml-2 text-lg ph-bold ph-arrow-right"></i>
                    </button>
                </div>
            </form>
